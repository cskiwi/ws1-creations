    ...
    $('.filestyle').each(function () {
        var $this = $(this),
            options = {
                ...
                'classButtonContainerClass': $this.attr('data-classButtonContainerClass'),
                'classInputContainerClass': $this.attr('data-classInputContainerClass'),
                'containerClass': $this.attr('data-containerClass'),
